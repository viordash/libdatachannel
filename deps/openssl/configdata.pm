...
our %config = (
  ...
  build_infos => [ "./build.info", "crypto/build.info", "ssl/build.info", "apps/build.info", "test/build.info", "util/build.info", "tools/build.info", "fuzz/build.info", "crypto/objects/build.info", "crypto/md4/build.info", "crypto/md5/build.info", "crypto/sha/build.info", "crypto/hmac/build.info", "crypto/poly1305/build.info", "crypto/des/build.info", "crypto/aes/build.info", "crypto/chacha/build.info", "crypto/modes/build.info", "crypto/bn/build.info", "crypto/ec/build.info", "crypto/rsa/build.info", "crypto/dh/build.info", "crypto/dso/build.info", "crypto/buffer/build.info", "crypto/bio/build.info", "crypto/stack/build.info", "crypto/lhash/build.info", "crypto/rand/build.info", "crypto/err/build.info", "crypto/evp/build.info", "crypto/asn1/build.info", "crypto/pem/build.info", "crypto/x509/build.info", "crypto/x509v3/build.info", "crypto/conf/build.info", "crypto/txt_db/build.info", "crypto/pkcs7/build.info", "crypto/pkcs12/build.info", "crypto/comp/build.info", "crypto/ocsp/build.info", "crypto/ui/build.info", "crypto/ts/build.info", "crypto/srp/build.info", "crypto/ct/build.info", "crypto/async/build.info", "crypto/kdf/build.info", "crypto/store/build.info", "test/ossl_shim/build.info" ],
  build_type => "release",
  builddir => ".",
  cflags => [  ],
  ...
  minor => "1.1",
  openssl_algorithm_defines => [ "OPENSSL_NO_ARIA", "OPENSSL_NO_BF", "OPENSSL_NO_BLAKE2", "OPENSSL_NO_CAMELLIA", "OPENSSL_NO_CAST", "OPENSSL_NO_CMAC", "OPENSSL_NO_CMS", "OPENSSL_NO_DSA", "OPENSSL_NO_IDEA", "OPENSSL_NO_MD2", "OPENSSL_NO_MDC2", "OPENSSL_NO_RC2", "OPENSSL_NO_RC4", "OPENSSL_NO_RC5", "OPENSSL_NO_RMD160", "OPENSSL_NO_SEED", "OPENSSL_NO_SIPHASH", "OPENSSL_NO_SM2", "OPENSSL_NO_SM3", "OPENSSL_NO_SM4", "OPENSSL_NO_WHIRLPOOL" ],
  openssl_api_defines => [ "OPENSSL_MIN_API=0x10000000L" ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_AFALGENG", "OPENSSL_NO_ASAN", "OPENSSL_NO_ASM", "OPENSSL_NO_ASYNC", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_ECDH", "OPENSSL_NO_ECDSA", "OPENSSL_NO_EGD", "OPENSSL_NO_ENGINE", "OPENSSL_NO_ERR", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_GOST", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_HW_PADLOCK", "OPENSSL_NO_MSAN", "OPENSSL_NO_OCB", "OPENSSL_NO_PINSHARED", "OPENSSL_NO_SCRYPT", "OPENSSL_NO_SCTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_TESTS", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_STATIC_ENGINE" ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "",
  options => "--api=1.0.0 --release enable-shared no-afalgeng no-aria no-asan no-asm no-async no-bf no-blake2 no-buildtest-c++ no-camellia no-cast no-cmac no-cms no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dsa no-ec_nistp_64_gcc_128 no-ecdh no-ecdsa no-egd no-engine no-err no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-gost no-heartbeats no-hw-padlock no-idea no-md2 no-mdc2 no-msan no-ocb no-pinshared no-rc2 no-rc4 no-rc5 no-rmd160 no-scrypt no-sctp no-seed no-siphash no-sm2 no-sm3 no-sm4 no-sse2 no-ssl-trace no-ssl3 no-ssl3-method no-tests no-ubsan no-unit-test no-weak-ssl-ciphers no-whirlpool no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.22.1",
  perlargv => [ "--api=1.0.0", "linux-x86", "--release", "shared", "no-async", "no-asm", "no-engine", "no-hw-padlock", "no-sse2", "no-tests", "no-ssl2", "no-zlib", "no-err", "no-camellia", "no-seed", "no-cms", "no-gost", "no-pinshared", "no-aria", "no-bf", "no-blake2", "no-camellia", "no-cast", "no-cmac", "no-dsa", "no-ecdh", "no-ecdsa", "no-idea", "no-mdc2", "no-ocb", "no-rc2", "no-rc4", "no-rc5", "no-rmd160", "no-scrypt", "no-seed", "no-siphash", "no-sm2", "no-sm3", "no-sm4", "no-whirlpool" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  sdirs => [ "objects", "md4", "md5", "sha", "hmac", "poly1305", "des", "aes", "chacha", "modes", "bn", "ec", "rsa", "dh", "dso", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "comp", "ocsp", "ui", "ts", "srp", "ct", "async", "kdf", "store" ],
  shlib_major => "1",
  shlib_minor => "1",
